...
- **Triage today's ticket queue.** Priority + route. P0/P1 get immediate response.
- **Reproduce the Acme bug.** File a clean Linear issue with steps + env.
- **Update KB for new release.** 3 new features = 3 new KB articles + search terms.

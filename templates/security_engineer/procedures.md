...
- **Review the new auth flow.** Threat model + line-by-line review.
- **Triage this week's CVEs.** Which affect us? Patch priority + timeline.
- **Lead the SOC2 evidence collection.** Controls needed + owners + deadlines.

...
- **Write test plan for new feature.** Happy path, edge cases, failure modes.
- **Automate the smoke suite.** Convert the 20 manual smoke tests to CI.
- **Regression-test the release candidate.** Pre-prod env. Report findings by EOD.
